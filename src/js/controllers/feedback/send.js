  ...
  $scope.$on("$ionicView.beforeEnter", function(event, data) {
    ...
    switch ($scope.score) {
      ...
      case 5:
        ...
        $scope.comment = gettextCatalog.getString("We're always looking for ways to improve Deuscoin.") + ' ' + gettextCatalog.getString("Is there anything we could do better?");
        break;
      default:
        $scope.justFeedback = true;
        $scope.comment = gettextCatalog.getString("We're always looking for ways to improve Deuscoin. How could we improve your experience?");
        break;
    }
  });
